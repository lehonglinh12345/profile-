  ...
  resources: {
    vi: {
      translation: {
        ...
        hero_description:
          "Phát triển website bằng Django, React, và Python. Đam mê công nghệ, kiểm thử phần mềm và học tiếng Nhật 🇯🇵 (JLPT N4).",
        ...
        highlight_1_title: "Web & Mobile Developer",
        highlight_1_desc: "Xây dựng website bằng Django, React và Python.",
    ...
    en: {
      translation: {
        ...
        highlight_1_title: "Web & Mobile Developer",
        highlight_1_desc: "Building websites using Django, React, and Python.",
    ...
    ja: {
      translation: {
        ...
        highlight_1_desc: "Django、React、Python を使ってウェブサイトを構築。",
